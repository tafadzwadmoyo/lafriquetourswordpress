...
class WDPS_Notices {
  protected $prefix = 'wdps';
  protected $plugin_url = WD_PS_URL;
  protected $plugin_version = "wdps_version";
  protected $plugin_name = 'Post Slider WD';
  ...
  public function wd_admin_notices() {
    ...
    $notices['two_week_review'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://wordpress.org/support/view/plugin-reviews/post-slider-wd?filter=5" target="_blank">' . __('Sure! I\'d love to!', $this->prefix) . '</a></li>
    ...
    $notices['one_week_support'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="https://web-dorado.com/wordpress-post-slider-wd/installing.html">' . __('Check out User Guide', $this->prefix) . '</a></li>
